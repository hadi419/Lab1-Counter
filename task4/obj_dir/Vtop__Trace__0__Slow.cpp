...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+5,"ld", false,-1);
    tracep->declBus(c+6,"bcd", false,-1, 11,0);
    ...
    tracep->declBus(c+7,"x", false,-1, 7,0);
    tracep->declBus(c+6,"BCD", false,-1, 11,0);
    tracep->declBus(c+8,"result", false,-1, 19,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+5,(vlSelf->ld));
    bufp->fullSData(oldp+6,(vlSelf->bcd),12);
    bufp->fullCData(oldp+7,(vlSelf->top__DOT__count),8);
    bufp->fullIData(oldp+8,(vlSelf->top__DOT__myDecoder__DOT__result),20);
